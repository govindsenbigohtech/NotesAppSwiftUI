...
//        coreDataManager.saveNote(title: titleTextField.text, body: bodyTextField.text)
//        print("Note saved: \(titleTextField.text ?? "") - \(bodyTextField.text ?? "")")
//        
//        // Remove overlay and alert view
//        for subview in view.subviews {
//            if subview.backgroundColor == .black || subview.backgroundColor?.cgColor.alpha == 0.5 {
...
class NotesViewController: UIViewController, UITextViewDelegate {
    ...
    // This is my code, initially when no data is there on tableview cell, I want my HomeVC to be visible along with "notesImg", when user save the data in tableview cell, then it should be visible on my NotesViewController, as soon as user adds data then it should be visible on tableview cell
