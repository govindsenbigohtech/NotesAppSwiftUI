...
//            print("New note mode: Text fields should be editable.")
//        } else if let note = noteToEdit {
//            titleTextField.text = note.title
//            bodyTextField.text = note.body
//            titleTextField.isEditable = false
//            bodyTextField.isEditable = false
//            print("Editing note mode: Text fields should be non-editable.")
//        }
//        
//        print("Title TextField Editable: \(titleTextField.isEditable)")
//        print("Body TextField Editable: \(bodyTextField.isEditable)")
//    }
//    
////    override func viewDidLoad() {
////        super.viewDidLoad()
...
////        
////        if isNewNote {
////            // If it's a new note, allow editing by default
////            titleTextField.isEditable = true
////            bodyTextField.isEditable = true
...
////            
////            if isNewNote {
////                // If it's a new note, show the save button and hide the edit button
////                saveButton.isHidden = false
////                editButton.isHidden = true
////            } else if let note = noteToEdit {
////                // If editing an existing note, populate the fields
...
//        
//        editButton = UIButton()
//        editButton.setImage(UIImage(named: "edit"), for: .normal) // Use an appropriate image for edit
...
////            titleTextField.isEditable = true
////            bodyTextField.isEditable = true
////            editButton.setTitle("Save", for: .normal) // Change button title to Save
////        } else {
////            // Disable editing and save changes
////            titleTextField.isEditable = false
////            bodyTextField.isEditable = false
////            editButton.setTitle("Edit", for: .normal) // Change button title back to Edit
////            
////            // Save the note
////            let title = titleTextField.text ?? ""
////            let body = bodyTextField.text ?? ""
...
//        } else {
//            // Existing logic for placeholder text
