...
//        // Set up UI based on the note data
...
//            bodyTextField.text = viewModel.body
//            titleTextField.isEditable = false
//            bodyTextField.isEditable = false
//            saveButton.isHidden = true
//            editButton.isHidden = false
...
//        viewModel.onNoteSaved = { [weak self] in
...
//        let title = titleTextField.text ?? ""
//        let body = bodyTextField.text ?? ""
//        viewModel.saveNote(title: title, body: body)
//    }
//    
//    @objc func editButtonTapped() {
//        titleTextField.isEditable.toggle()
//        bodyTextField.isEditable.toggle()
//        saveButton.isHidden = !titleTextField.isEditable
//    }
//    
//    @objc func backButtonTapped() {
...
//extension NotesViewController: UITextViewDelegate {
//    func textViewDidBeginEditing(_ textView: UITextView) {
//        if textView == titleTextField, textView.text == titlePlaceholder {
//            textView.text = ""
//            textView.textColor = .black
//        } else if textView == bodyTextField, textView.text == bodyPlaceholder {
//            textView.text = ""
//            textView.textColor = .black
//        }
//    }
//    
//    func textViewDidEndEditing(_ textView: UITextView) {
//        if textView == titleTextField, textView.text.isEmpty {
//            textView.text = titlePlaceholder
//            textView.textColor = .lightGray
//        } else if textView == bodyTextField, textView.text.isEmpty {
